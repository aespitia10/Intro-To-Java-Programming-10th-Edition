...
public class PrintCalendar 
{
    ...
    public static void printMonthBody(int year, int month)
    {
        ...
        int numberOfDaysInMonth = getnNumberOfDaysInMonth(year,month);
    ...
    public static int getTotalNumberOfDays(int year, int month)
    {
        ...
        {
            total = total + getnNumberOfDaysInMonth(year,i);
        }
        return total;
    }

    public static int getnNumberOfDaysInMonth(int year, int month)
    {
        switch(month)
        {
